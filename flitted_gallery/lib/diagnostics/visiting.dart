...
/**
 * Widget tree annotated with their ctor locations
 */
Future<Map<String, dynamic>> debugReturnWidgetTreeAnnotated(
    Map<String, String> parameters) async {
  List<Map<String, dynamic>> stack = [
    {'children': []}
  ];
...
// the root of the element tree
  ...
  Map<String, dynamic> mapWidget(e) {
    return {
      'type': mapType(e.runtimeType), 'location' : e.widget?.ctorLocation};
  }
